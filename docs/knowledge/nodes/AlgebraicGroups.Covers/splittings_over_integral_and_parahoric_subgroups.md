---
id: covers.splittings_over_integral_and_parahoric_subgroups
...
uses:
- covers.local_and_global_metaplectic_covers
- buildings.parahoric_subgroups
verification:
  definition: accepted
...
(see [[node:covers.local_and_global_metaplectic_covers|local and global metaplectic covers]]).
...
- [[node:covers.local_and_global_metaplectic_covers|Local and Global Metaplectic Covers]]
