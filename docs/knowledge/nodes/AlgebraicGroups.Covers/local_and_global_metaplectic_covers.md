---
id: covers.local_and_global_metaplectic_covers
...
uses:
- covers.brylinski_deligne_k2_extensions
- foundations.local_fields
- foundations.global_fields_adeles_and_reciprocity_symbols
verification:
  definition: accepted
...
- [[node:covers.brylinski_deligne_k2_extensions|Brylinski-Deligne K2-Extensions]]
- [[node:foundations.local_fields|Local Fields]]
- [[node:foundations.global_fields_adeles_and_reciprocity_symbols|Global Fields, Adeles, and Reciprocity Symbols]]
