...
[[node:reductive_groups.borel_subgroups|reductive structure]] (root data,
parabolics, Borel subgroups),
[[node:forms.forms_of_algebraic_groups|descent and forms]] (inner/outer forms,
quasi-split groups), and
[[node:buildings.bn_pairs_and_tits_systems|buildings and parahorics]] (the
