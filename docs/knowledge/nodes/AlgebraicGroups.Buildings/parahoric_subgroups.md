---
id: buildings.parahoric_subgroups
...
uses:
- buildings.facets_in_bruhat_tits_buildings
...
- [[node:buildings.facets_in_bruhat_tits_buildings|Facets in Bruhat-Tits Buildings]]
