---
id: buildings_and_parahorics.facets_in_bruhat_tits_buildings
...
uses:
- buildings_and_parahorics.bruhat_tits_buildings
verification:
  definition: accepted
...
- [[node:buildings_and_parahorics.bruhat_tits_buildings|Bruhat-Tits Buildings]]
