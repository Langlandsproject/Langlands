---
id: root_data_and_duality.classification_of_root_systems
...
- root_data_and_duality.root_form_and_positive_definiteness
---
...
1. **Positivity.** The root form (see
   [[node:root_data_and_duality.root_form_and_positive_definiteness|Root Form]])
...
- [[node:root_data_and_duality.root_form_and_positive_definiteness|Root Form and Positive Definiteness]]
- [[node:root_data_and_duality.root_chains|Root Chains and the String Property]]
