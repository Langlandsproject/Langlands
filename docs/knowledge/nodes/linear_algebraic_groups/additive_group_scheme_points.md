---
id: linear_algebraic_groups.additive_group_scheme_points
...
*Proof.*  
The
[[node:linear_algebraic_groups.points_functor_definition|\(R\)-points of \(\mathbb{G}_a\) over \(\operatorname{Spec} k\)]]
