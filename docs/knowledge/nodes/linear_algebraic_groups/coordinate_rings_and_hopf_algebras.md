---
id: linear_algebraic_groups.coordinate_rings_and_hopf_algebras
...
[[node:foundational_inputs.hopf_algebras|Hopf algebras]] is the
ring-theoretic notion of a commutative \(R\)-Hopf algebra.

The right side is captured by the
[[node:linear_algebraic_groups.affine_group_scheme_definition|`IsAffineGroupScheme`]]
predicate plus the
[[node:linear_algebraic_groups.hopf_spec_essential_image_affine|essential
...
- [[node:linear_algebraic_groups.hopf_spec_functor|`hopfSpec`]] — the
  functor `Spec` lifted to Hopf algebras and group schemes.
- [[node:linear_algebraic_groups.hopf_spec_grpobj_via_yoneda|Yoneda
...
- [[node:linear_algebraic_groups.hopf_spec_fully_faithful|fully
  faithful]] +
  [[node:linear_algebraic_groups.hopf_spec_essential_image_affine|essential
