...
- kottwitz_structures
uses:
- kottwitz_structures.sigma_conjugacy_classes
- kottwitz_structures.kottwitz_homomorphism
...
- [[node:kottwitz_structures.sigma_conjugacy_classes|Sigma-Conjugacy Classes]]
- [[node:kottwitz_structures.kottwitz_homomorphism|Kottwitz Homomorphism]]
