---
id: affine_group_schemes.general_linear_group_scheme_points
...
*Proof.*  
The
[[node:affine_group_schemes.points_functor_definition|\(R\)-points of \(\operatorname{GL}_n\) over \(\operatorname{Spec} k\)]]
