---
id: affine_group_schemes.algebra_hom_convolution
...
[[node:foundations.hopf_algebras|the Hopf algebra
...
[[node:affine_group_schemes.convolution_of_algebra_homs_is_algebra_hom|the next theorem]].
