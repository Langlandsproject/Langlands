---
id: foundational_inputs.global_fields_adeles_and_reciprocity_symbols
...
[[node:foundational_inputs.local_fields|local field]] with ring of
...
- **Tame symbol** at a non-archimedean place — see
  [[node:foundational_inputs.algebraic_k_theory_and_k2|\(K_2\)]] for
...
- The metaplectic groups
  ([[node:bd_covers.local_and_global_metaplectic_covers|BD covers]])
