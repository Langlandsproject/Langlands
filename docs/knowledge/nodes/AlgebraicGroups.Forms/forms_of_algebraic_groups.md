---
id: forms.forms_of_algebraic_groups
...
- forms.forms_of_algebraic_objects
- forms.cocycles_and_twisting
...
- **Pure inner forms** ([[node:forms.pure_inner_twists|Vogan]]) — refined to track
  more representation-theoretic data;
- **Rigid inner forms** ([[node:forms.rigid_inner_twists|Kaletha]]) — uses Galois
  gerbes;
- **Refined inner forms** ([[node:forms.kaletha_refined_inner_forms|Kaletha]]) — strictly
  finer than rigid.
...
- [[node:forms.forms_of_algebraic_objects|Forms of Algebraic Objects]]
- [[node:forms.cocycles_and_twisting|Cocycles and Twisting]]
