---
id: forms.kaletha_refined_inner_forms
...
uses:
- forms.rigid_inner_forms
- kottwitz.kottwitz_map_on_b_of_g
- kottwitz.b_of_g
verification:
  definition: accepted
...
- [[node:forms.rigid_inner_forms|Rigid Inner Forms]]
- [[node:kottwitz.kottwitz_map_on_b_of_g|Kottwitz Map on B(G)]]
