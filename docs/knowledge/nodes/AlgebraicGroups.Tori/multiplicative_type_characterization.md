...
- reductive_groups.diagonalizable_groups
...
[[node:reductive_groups.diagonalizable_groups|diagonalizable group]]),
...
\(k[M]\), by [[node:reductive_groups.diagonalizable_groups_antiequivalence]].
