---
id: affine_group_schemes.hopf_spec_grpobj_via_yoneda
...
- affine_group_schemes.spec_representability_via_global_sections
...
[[node:affine_group_schemes.algebra_homs_form_group_under_convolution|the convolution group structure]],
the set
...
[[node:affine_group_schemes.spec_representability_via_global_sections|the \(\operatorname{Spec} \dashv \Gamma\) adjunction]],
...
and reuses
[[node:affine_group_schemes.algebra_homs_form_group_under_convolution|the dedicated theorem]].
