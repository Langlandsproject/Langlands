---
id: affine_group_schemes.multiplicative_group_scheme_points
...
*Proof.*  
The
[[node:affine_group_schemes.points_functor_definition|\(R\)-points of \(\mathbb{G}_m\) over \(\operatorname{Spec} k\)]]
