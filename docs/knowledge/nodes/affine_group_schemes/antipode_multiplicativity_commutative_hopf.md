---
id: affine_group_schemes.antipode_multiplicativity_commutative_hopf
...
- affine_group_schemes.multiplication_is_coalgebra_hom
lean:
  modules:
...
By [[node:affine_group_schemes.multiplication_is_coalgebra_hom|the bialgebra axioms]],
...
[[node:affine_group_schemes.multiplication_is_coalgebra_hom|\(\mu\) being a coalgebra hom]]
...
\(S(b) S(a)\). See
[[node:affine_group_schemes.antipode_anti_multiplicativity|the
